...
extern int shell_get(const char *shellcmd, char *buffer_out, unsigned int buffer_out_len);
extern int shell_get_noent(const char *shellcmd, char *buffer_out, unsigned int buffer_out_len);
extern int swap(char * in, int len);
extern char *iphex2str(unsigned int ipaddr);
extern int PostStrDecode( char *str );
extern void IccidExchage( uint8_t *code );
extern char *strupr(char *input);
extern char *strlwr(char *input);
