...
#define FIRMWARE_SIZE		(10240*KB)

// uci command 
#define UCI_CMD_SIZE	128
...
#define BAUD_MAX_SIZE			115200
#define BAUD_MIN_SIZE			300
...
#define SYS_RESTART()             	system("reboot -d 2")
#define SYS_RELOAD()             	system("/etc/reset_param")
#define SYS_CLEAR()             	system("/etc/reset_param")
...
typedef enum
{
	...
	SOCK_TYPE_HTTPD_CLIENT	= 4,
	SOCK_TYPE_SSL_CLIENT	= 5,
} SOCK_TYPE;
