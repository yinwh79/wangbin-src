...
//
//*****************************************************************************
static volatile unsigned int g_ui32UARTTxWriteIndex = 0;
static volatile unsigned int g_ui32UARTTxReadIndex = 0;
...
//
//*****************************************************************************
static volatile unsigned int g_ui32UARTRxWriteIndex = 0;
static volatile unsigned int g_ui32UARTRxReadIndex = 0;
...
//
//*****************************************************************************
tRingBufObject g_sRxBuf[SOCKET_CLIENT_MAX]; 
...
//
//*****************************************************************************
tRingBufObject g_sTxBuf[SOCKET_CLIENT_MAX];
...
//*****************************************************************************
static void
UpdateIndexAtomic(volatile unsigned int *pui32Val, unsigned int ui32Delta,
...
{
    unsigned int ui32Write;
    unsigned int ui32Read;
...
RingBufFlush(tRingBufObject *psRingBuf)
{
    ...
    //
    // bIntsOff = IntMasterDisable();
    psRingBuf->ui32ReadIndex = psRingBuf->ui32WriteIndex = 0;
/*     if(!bIntsOff)
    {
        IntMasterEnable();
    }
...
//*****************************************************************************
void
RingBufRead(tRingBufObject *psRingBuf, char *pui8Data, unsigned int ui32Length)
{
...
//*****************************************************************************
void
RingBufAdvanceRead(tRingBufObject *psRingBuf, unsigned int ui32NumBytes)
{
...
//*****************************************************************************
void
RingBufWriteOne(tRingBufObject *psRingBuf, char ui8Data)
{
    //
    // Check the arguments.
    //
...
//*****************************************************************************
void
RingBufWrite(tRingBufObject *psRingBuf, char *pui8Data,
...
//*****************************************************************************
void
RingBufInit(tRingBufObject *psRingBuf, char *pui8Buf,
            unsigned int ui32Size)
{
    //
    // Check the arguments.
